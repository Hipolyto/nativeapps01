...
namespace iportogruaroIOS
{
    public static class InternetConnection {
        ...
        public static bool IsNetworkAvaialable (out NetworkReachabilityFlags flags)
        {
            ...
            using (var r = new NetworkReachability (HostName)){
                ...
                if (r.TryGetFlags (out flags)){             
                    ...
                    if (!IsReachableWithoutRequiringConnection (flags) && sendMessage)                  
                        return false;//Tools.ShowAlert (Language.GetString ("BEM00121"));//No hay conexiﾃ嗜 a Internet no podra realizar ninguna busqueda
