...
namespace iportogruaroIOS
{
    ...
    public class UiEventsListController : UITableViewController
    {
        #region "propierties"
        ...
        public UiEventsListController () : base (UITableViewStyle.Plain)
        {
        ...
        public override void ViewDidLoad ()
        {
            ...
            bool refreshList = NSUserDefaults.StandardUserDefaults.BoolForKey ("refreshList");
            ...
            if (refreshList)
                ...
                var lst = new iportogruaroLibraryShared.mainEventos().getMainCategorys(useFalse);
        ...
        public override void ViewDidAppear (bool animated)
        {
            ...
            ThreadPool.QueueUserWorkItem (state =>
                ...
                if (refreshList)
                {
                    NSUserDefaults.StandardUserDefaults.SetBool(false,"refreshList");
