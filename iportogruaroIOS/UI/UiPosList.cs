...
{
    public partial class UiPosList : UIViewController
    {
        ...
        public  bool UserInterfaceIdiomIsPhoneNo {
            get { return UIDevice.CurrentDevice.UserInterfaceIdiom == UIUserInterfaceIdiom.Phone; }
        }
        ...
        public UiPosList ()
            : base (UserInterfaceIdiomIsPhone ? "UiPosListiPhone" : "UiPosListiPad", null)
        {
            modeSearch = false;
        }
        public UiPosList (bool serach)  : base (UserInterfaceIdiomIsPhone ? "UiPosListiPhone" : "UiPosListiPad", null)
        {
            modeSearch = true;
        }
		...
		private sourceSecondCategory sourcePos{ get; set;}
