...
{
    public class UiPosListController : UITableViewController
    {
		#region "propierties"
        ...
        public UiPosListController (bool serach) : base (UITableViewStyle.Plain)
        {
            modeSearch = true;
        }

        public UiPosListController () : base (UITableViewStyle.Plain)
        {
            modeSearch = false;
        }
        ...
        public override void ViewDidLoad ()
        {
            ...
            setstyle ();
            if (modeSearch == true) {
                TableView.Source = new sourceSecondCategory (null, lstSearch);
                ...
                ThreadPool.QueueUserWorkItem (state =>
					...
					InvokeOnMainThread (delegate {
						TableView.Source = new sourcePosItems (this,lst);
						TableView.ReloadData();
						setLoadingViewStyle(this.TableView);
                        reloading = false;
...
*/
        ...
        #endregion
        #region style
        MonoTouch.UIKit.UITabBar bar{ get; set;}
        private void setstyle ()
        {
            try {
                ...
                bar = new UITabBar (new RectangleF(0,400,this.View.Bounds.Width,45));

                var bar1 =  new UITabBarItem(UITabBarSystemItem.Contacts, 0);
                var bar2 =  new UITabBarItem( "title",null,1);

                UITabBarItem[] Items = new UITabBarItem[] { bar1 ,bar2};
                bar.Items = Items;
        ...
        public List<iportogruaropos> lst{ get; set; }
